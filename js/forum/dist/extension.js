...
;
System.register('test/mentions/addComposerAutocomplete', ['flarum/extend', 'flarum/components/ComposerBody', 'flarum/helpers/avatar', 'flarum/helpers/username', 'flarum/helpers/highlight', 'flarum/utils/string', 'test/mentions/components/AutocompleteDropdown'], function (_export) {
      ...
      $textarea.after($container).on('keydown', dropdown.navigate.bind(dropdown)).on('click keyup', function (e) {
        ...
        if (mentionStart) {
          (function () {
            ...
            var makeSuggestion = function makeSuggestion(title, replacement, content) {
            ...
            var buildSuggestions = function buildSuggestions() {
              ...
              */
              ...
              if (typed) {
                app.store.all('discussions').forEach(function (disc) {
                  console.log(disc);
                  if (disc.title().toLowerCase().substr(0, typed.length) !== typed) return;
                  suggestions.push(makeSuggestion(disc.title(), '[URL=/flarum/d/' + disc.id() + '/]' + disc.title() + '[/URL]', disc.title(), 'MentionsDropdown-user'));
                });
              }
            ...
            if (typed) {
              searchTimeout = setTimeout(function () {
                ...
                if (searched.indexOf(typedLower) === -1) {
                  app.store.find('discussions', { q: typed, page: { limit: 5 } }).then(function () {
  ...
  return {
    ...
    }, function (_testMentionsComponentsAutocompleteDropdown) {
      AutocompleteDropdown = _testMentionsComponentsAutocompleteDropdown['default'];
    }],
    execute: function () {}
  };
});;
System.register('test/mentions/addMentionedByList', ['flarum/extend', 'flarum/Model', 'flarum/models/Post', 'flarum/components/CommentPost', 'flarum/components/PostPreview', 'flarum/helpers/punctuateSeries', 'flarum/helpers/username', 'flarum/helpers/icon'], function (_export) {
  'use strict';
...
System.register('test/mentions/addPostMentionPreviews', ['flarum/extend', 'flarum/components/CommentPost', 'flarum/components/PostPreview', 'flarum/components/LoadingIndicator'], function (_export) {
  'use strict';
...
System.register('test/mentions/addPostReplyAction', ['flarum/extend', 'flarum/components/Button', 'flarum/components/CommentPost', 'flarum/utils/DiscussionControls'], function (_export) {
  'use strict';
...
System.register('test/mentions/components/AutocompleteDropdown', ['flarum/Component'], function (_export) {
  'use strict';
...
System.register('test/mentions/components/PostMentionedNotification', ['flarum/components/Notification', 'flarum/helpers/username', 'flarum/helpers/punctuateSeries'], function (_export) {
  'use strict';
...
System.register('test/mentions/components/UserMentionedNotification', ['flarum/components/Notification'], function (_export) {
  'use strict';
...
System.register('test/mentions/main', ['flarum/extend', 'flarum/app', 'flarum/components/NotificationGrid', 'flarum/utils/string', 'test/mentions/addPostMentionPreviews', 'test/mentions/addMentionedByList', 'test/mentions/addPostReplyAction', 'test/mentions/addComposerAutocomplete', 'test/mentions/components/PostMentionedNotification', 'test/mentions/components/UserMentionedNotification'], function (_export) {
  'use strict';
  ...
  return {
    ...
    }, function (_testMentionsAddPostMentionPreviews) {
      addPostMentionPreviews = _testMentionsAddPostMentionPreviews['default'];
    }, function (_testMentionsAddMentionedByList) {
      addMentionedByList = _testMentionsAddMentionedByList['default'];
    }, function (_testMentionsAddPostReplyAction) {
      addPostReplyAction = _testMentionsAddPostReplyAction['default'];
    }, function (_testMentionsAddComposerAutocomplete) {
      addComposerAutocomplete = _testMentionsAddComposerAutocomplete['default'];
    }, function (_testMentionsComponentsPostMentionedNotification) {
      PostMentionedNotification = _testMentionsComponentsPostMentionedNotification['default'];
    }, function (_testMentionsComponentsUserMentionedNotification) {
      UserMentionedNotification = _testMentionsComponentsUserMentionedNotification['default'];
    }],
    execute: function () {

      app.initializers.add('tai-mentions', function () {
